...
<body>
	...
	<ul>
		...
		<li><a href="./?pagina=logout"><i class="fas fa-sign-out-alt"></i></a></li>
	</ul>
	...
	<div class="vizualizare">
		...
		<?php
			...
			if ($result = $mysqli->query("SELECT * FROM adoptie ORDER BY id "))
			{ 
				if ($result->num_rows > 0)
				{
					echo "<table border='1' cellpadding='10'>";
					echo "<tr><th>Nume </th><th>Email</th><th>Telefon</th><th>Adoptie/foster</th><th>Animal</th><th>Numele animalului</th></tr>";
					while ($row = $result->fetch_object())
					{
						...
						echo "<td>" . $row->alegere . "</td>";
						echo "<td>" . $row->animal . "</td>";
						echo "<td>" . $row->nume_animal . "</td>";
						echo "</tr>";
					}
					echo "</table>";
				}
