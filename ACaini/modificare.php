...
{ 
if ($stmt = $mysqli->prepare("UPDATE caini SET nume=?, varsta=?, poza1=?, poza2=? WHERE id='".$id."'"))
{
...
<form action="" method="post">
	<?php if ($_GET['id'] != '') { ?>
		...
		if ($result = $mysqli->query("SELECT * FROM caini where id='".$_GET['id']."'"))
	{
	...
	<a href="vizualizare.php">Tabel caini</a>
	</div>
</form>
</body> 
</html>