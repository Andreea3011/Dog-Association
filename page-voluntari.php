...
tr:hover {background-color: #bdc7f0;}
...
<body>
	...
	<div class="vizualizare">
		...
		<?php
			...
			if ($result = $mysqli->query("SELECT * FROM voluntari ORDER BY id "))
			{ 
				if ($result->num_rows > 0)
				{
					echo "<table border='1' cellpadding='10'>";
					echo "<tr><th>Nume </th><th>Email</th><th>Telefon</th><th>Adresa</th><th>Oras</th><th>Tara</th><th>Varsta</th><th>Mesaj</th></tr>";
