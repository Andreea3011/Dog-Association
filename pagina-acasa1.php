   ...
   <!-- <div id = "myCarousel" class = "carousel slide" data-bs-ride = "carousel">
	...
	<div class="nume">
			...
			<nav class="navbar navbar-expand-sm navbar-dark" id="navbar">
                <a class="navbar-brand" href="./?pagina=acasa">Acasă</a>   
                <a class="nav-item">
                    <a class="nav-link" href="./?pagina=despre">Despre noi</a>
                </a>
                <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="./?pagina=voluntari">Alătură-te voluntarilor</a>
                            <a class="dropdown-item" href="./?pagina=doneaza">Donează</a>
                        </div>
                </div>
				<a class="nav-item">
                    <a class="nav-link" href="\cc\Categorii\categorii.php">Adoptă</a>
                </a>
                <a class="nav-item">
                    <a class="nav-link" href="./?pagina=contact">Contact</a>
                </a>
				<a class="nav-item">
				    <a class="nav-link" href="quiz.html">Quiz</a>
			    <a class="nav-item">
			<a class="nav-link" href="pagina-logout.php"><i class="fas fa-sign-out-alt"></i></i></a>
		</a>
             </nav>
