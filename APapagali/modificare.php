...
{ 
if ($stmt = $mysqli->prepare("UPDATE papagali SET nume=?, varsta=?, poza1=?, poza2=? WHERE id='".$id."'"))
{
...
<form action="" method="post">
	<?php if ($_GET['id'] != '') { ?>
		...
		if ($result = $mysqli->query("SELECT * FROM papagali where id='".$_GET['id']."'"))
	{
	...
	<a href="vizualizare.php">Tabel papagali</a>
	</div>
</form>
</body> 
</html>